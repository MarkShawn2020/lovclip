...
$(builddir)/accessibility.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/accessibility.node: LIBS := $(LIBS)
$(builddir)/accessibility.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/accessibility.node: TOOLSET := $(TOOLSET)
$(builddir)/accessibility.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/accessibility.node
# Add target alias
.PHONY: accessibility
accessibility: $(builddir)/accessibility.node

# Short alias for building this executable.
.PHONY: accessibility.node
accessibility.node: $(builddir)/accessibility.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/accessibility.node
